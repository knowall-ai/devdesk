...
[source,bash]
----
az webapp log tail --name devdesk-knowall --resource-group KnowAllAIRG
----

Or download logs:
[source,bash]
----
az webapp log download --name devdesk-knowall --resource-group KnowAllAIRG --log-file logs.zip
----
...
# Azure App Service
az webapp config appsettings list --name devdesk-knowall --resource-group KnowAllAIRG
----
